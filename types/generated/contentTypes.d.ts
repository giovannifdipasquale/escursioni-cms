...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    team_photo: Schema.Attribute.Media<'images'>;
...
export interface ApiActivityTypeActivityType
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    related_trails: Schema.Attribute.Relation<'manyToMany', 'api::trail.trail'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['cultural', 'seasonal', 'sport']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    location: Schema.Attribute.Component<'common.geo-point', false> &
      Schema.Attribute.Required;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    highlighted_trails: Schema.Attribute.Relation<
      'manyToMany',
      'api::trail.trail'
    >;
...
export interface ApiHutHut extends Struct.CollectionTypeSchema {
  collectionName: 'huts';
  info: {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hut.hut'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'common.geo-point', false>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings: logo, contact, social';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    site_title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTrailTrail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity_types: Schema.Attribute.Relation<
      'manyToMany',
      'api::activity-type.activity-type'
    >;
    ...
    difficulty: Schema.Attribute.Enumeration<['easy', 'moderate', 'hard']> &
      Schema.Attribute.Required;
    duration_hours: Schema.Attribute.Integer;
    elevation_gain_m: Schema.Attribute.Integer;
    gpx_file: Schema.Attribute.Media<'files'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trail.trail'>;
    location: Schema.Attribute.Component<'common.geo-point', false>;
    publishedAt: Schema.Attribute.DateTime;
    related_huts: Schema.Attribute.Relation<'manyToMany', 'api::hut.hut'>;
